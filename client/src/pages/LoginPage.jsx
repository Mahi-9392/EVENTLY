      ...
      >
        <div className="glass rounded-3xl p-8 shadow-2xl sm:p-10">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-slate-600">Sign in to book tickets and manage your plans.</p>
          </div>
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                className="w-full rounded-2xl border border-slate-200/80 bg-white/90 px-4 py-3 text-slate-800 shadow-inner outline-none transition focus:border-indigo-400 focus:ring-2 focus:ring-indigo-400/30"
                type="email"
                value={email}
